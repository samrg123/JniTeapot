...
import { Event, Payload, Response, Transport, TransportOptions } from '@amplitude/types';
...
export declare abstract class BaseTransport implements Transport {
    ...
    /** JSDoc */
    protected _sendWithModule(httpModule: HTTPRequest, payload: Payload): Promise<Response>;
}
